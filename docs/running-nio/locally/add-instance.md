...
Once your instance is loaded and available, you can add services and blocks in the same manner as the [cloud instance](https://docs.n.io/running-nio/in-the-cloud.html#create-service).
