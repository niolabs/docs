...
---
## Signals
[Signals](https://docs.n.io/signals) are what make your nio systems go. They can be generated by hardware, software, or humans, and should be a fundamental consideration when designing with nio.
